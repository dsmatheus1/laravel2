...
Route::get('/detalhesAnimal', [App\Http\Controllers\DetalhesAnimal::class, 'detalhesAnimal'])->name('detalhes-animal');
...
Route::post('/animal', [App\Http\Controllers\Animal::class, 'addAnimal'])->name('addanimal');
